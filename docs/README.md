...
| [Search Ai Service](content-services/services/search-ai.service.md) | Retrieves the Knowledge Discovery URL configuration from the HXI Connector. | [Source](../lib/content-services/src/lib/search-ai/services/search-ai.service.ts) |
