...
| [Permission list component](content-services/permission-list.component.md) | ![Permission List](../docassets/images/adf-permission-list.png) | [Source](../lib/content-services/permission-manager/components/permission-list/permission-list.component.ts) |
...
| _Inherited button directive_ | _Not currently documented_ | [Source](../lib/content-services/permission-manager/components/inherited-button.directive.ts) |
