...
| enableDragRows           | `boolean`                                                                                                               | false                 | Flag that enables dragging rows. When true, the rows can be dragged, otherwise they can't.                                                                                                                                                                                                                                                                                                                    |
| dropListConnectedTo      | `string[]`                                                                                                              | []                    | The connected drop lists for drag and drop functionality. When set, the rows can be dragged and dropped to other components with linked drop lists.                                                                                                                                                                                                                                                           |
