...
| [Permission list component](permission-list.component.md) | ![Permission List](../docassets/images/adf-permission-list.png) | [Source](../../lib/content-services/permission-manager/components/permission-list/permission-list.component.ts) |
