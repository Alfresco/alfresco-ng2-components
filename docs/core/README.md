...
| [Host settings component](host-settings.component.md) ![Internal](../docassets/images/InternalIcon.png) | `This component Note this component is not meant to be used in production`
