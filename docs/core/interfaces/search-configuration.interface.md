...
# [Search Configuration interface](lib/content-services/src/lib/search/interfaces/search-configuration.interface.ts "Defined in search-configuration.interface.ts")
