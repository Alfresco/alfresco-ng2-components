...
describe('Applications list', () => {
    ...
    it('[C289910] Should the app be displayed on dashboard when is deployed on APS', async () => {
        ...
        await appListCloudPage.checkAppIsDisplayed(browser.params.ACTIVITI_CLOUD_APPS.CANDIDATE_BASE_APP.name);
        await appListCloudPage.checkAppIsDisplayed(browser.params.ACTIVITI_CLOUD_APPS.SUB_PROCESS_APP.name);
