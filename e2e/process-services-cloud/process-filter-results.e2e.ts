...
describe('Process filters cloud', () => {
    ...
    const simpleApp = browser.params.ACTIVITI_CLOUD_APPS.SIMPLE_APP.name;
    ...
    beforeAll(async () => {
        ...
        simpleAppProcessDefinition = await processDefinitionService
            .getProcessDefinitionByName(browser.params.ACTIVITI_CLOUD_APPS.SIMPLE_APP.processes.simpleProcess, simpleApp);
        ...
        processDefinition = await processDefinitionService
            .getProcessDefinitionByName(browser.params.ACTIVITI_CLOUD_APPS.CANDIDATE_BASE_APP.processes.candidateGroupProcess, candidateBaseApp);

        anotherProcessDefinition = await processDefinitionService
            .getProcessDefinitionByName(browser.params.ACTIVITI_CLOUD_APPS.CANDIDATE_BASE_APP.processes.anotherCandidateGroupProcess, candidateBaseApp);
