...
describe('Task form cloud component', () => {
    ...
    beforeAll(async () => {
        ...
        const assigneeProcessDefinition = await processDefinitionService.getProcessDefinitionByName(resources.ACTIVITI_CLOUD_APPS.SIMPLE_APP.processes.calledprocess, simpleApp);
