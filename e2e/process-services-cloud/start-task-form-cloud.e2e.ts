...
describe('Start Task Form', () => {
    ...
    const candidateBaseApp = browser.params.ACTIVITI_CLOUD_APPS.CANDIDATE_BASE_APP.name;
    ...
    beforeAll(async () => {
        ...
        processDefinition = await processDefinitionService
            .getProcessDefinitionByName(browser.params.ACTIVITI_CLOUD_APPS.CANDIDATE_BASE_APP.processes.uploadFileProcess, candidateBaseApp);
    ...
    describe('StandaloneTask with form', () => {
        ...
        it('[C307976] Should be able to start and save a task with a form', async () => {
            ...
            await startTask.selectFormDefinition(browser.params.ACTIVITI_CLOUD_APPS.CANDIDATE_BASE_APP.forms.starteventform);
        ...
        it('[C311428] Should display the Standalone forms based on the flag set', async () => {
            ...
            await startTask.checkFormDefinitionIsDisplayed(browser.params.ACTIVITI_CLOUD_APPS.CANDIDATE_BASE_APP.forms.starteventform);
            await startTask.checkFormDefinitionIsDisplayed(browser.params.ACTIVITI_CLOUD_APPS.CANDIDATE_BASE_APP.forms.formtotestvalidations);
        });
