...
describe('Content Services Viewer', () => {
    ...
    describe('.pdf tests :', () => {
        ...
        beforeAll(async (done) => {
            ...
            let fileUploaded = await uploadActions.uploadFile(this.alfrescoJsApi, pdfFile.location, pdfFile.name, '-my-');
            Object.assign(pdfFile, fileUploaded.entry);
    ...
    describe('.jpg files : ', () => {
        ...
        beforeAll(async (done) => {
            let uploadActions = new UploadActions();
            let fileUploaded = await uploadActions.uploadFile(this.alfrescoJsApi, jpgFile.location, jpgFile.name, '-my-');
            Object.assign(jpgFile, fileUploaded.entry);
    ...
    describe('.ppt files :', () => {
        ...
        beforeAll(async (done) => {
            let uploadActions = new UploadActions();
            let fileUploaded = await uploadActions.uploadFile(this.alfrescoJsApi, pptFile.location, pptFile.name, '-my-');
            Object.assign(pptFile, fileUploaded.entry);
    ...
    describe('.docx files :', () => {
        ...
        beforeAll(async (done) => {
            let uploadActions = new UploadActions();
            let fileUploaded = await uploadActions.uploadFile(this.alfrescoJsApi, docxFile.location, docxFile.name, '-my-');
            Object.assign(docxFile, fileUploaded.entry);
    ...
    describe('Unsupported files :', () => {
        ...
        beforeAll(async (done) => {
            let uploadActions = new UploadActions();
            let fileUploaded = await uploadActions.uploadFile(this.alfrescoJsApi, unsupportedFile.location, unsupportedFile.name, '-my-');
            Object.assign(unsupportedFile, fileUploaded.entry);
    ...
    describe('media files :', () => {
        ...
        beforeAll(async (done) => {
            let uploadActions = new UploadActions();
            let fileUploaded = await uploadActions.uploadFile(this.alfrescoJsApi, mp4File.location, mp4File.name, '-my-');
            Object.assign(mp4File, fileUploaded.entry);
    ...
    describe('Protected files :', () => {
        ...
        beforeAll(async (done) => {
            let uploadActions = new UploadActions();
            let fileUploaded = await uploadActions.uploadFile(this.alfrescoJsApi, protectedFile.location, protectedFile.name, '-my-');
            Object.assign(protectedFile, fileUploaded.entry);
