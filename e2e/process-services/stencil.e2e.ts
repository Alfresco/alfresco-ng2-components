...
import { LoginSSOPage, ApplicationsUtil, StartProcessPage, ApiService, UserModel, getTestResources } from '@alfresco/adf-testing';
...
describe('Stencil', () => {
    ...
    const app = resources.Files.STENCIL_PROCESS;
