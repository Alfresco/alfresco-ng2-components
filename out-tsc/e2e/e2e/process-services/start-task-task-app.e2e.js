...
describe('Start Task - Task App', function () {
    ...
    var taskName255Characters = adf_testing_2.StringUtil.generateRandomString(255);
    var taskNameBiggerThen255Characters = adf_testing_2.StringUtil.generateRandomString(256);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    pathFile = path.join(protractor_2.browser.params.testConfig.main.rootPath + app.file_location);
                ...
                case 6:
                    _a.sent();
                    return [4 /*yield*/, this.alfrescoJsApi.activiti.taskApi.createNewTask({ name: showHeaderTask })];
                case 7:
                    _a.sent();
    ...
    it('[C260383] Should be possible to modify a task', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 12: return [4 /*yield*/, _a.apply(void 0, [_b.sent()])
                ...
                case 17: return [4 /*yield*/, (_b.sent()).addName(firstChecklist)];
                case 18:
                    _b.sent();
                    checklistDialog = new createChecklistDialog_1.ChecklistDialog();
                    return [4 /*yield*/, checklistDialog.clickCreateChecklistButton()];
                case 19:
                    _b.sent();
                    return [4 /*yield*/, taskPage.checkChecklistIsDisplayed(firstChecklist)];
                case 20:
                    _b.sent();
                    return [4 /*yield*/, taskPage.taskDetails().selectDetailsTab()];
                case 21:
                    _b.sent();
                    return [2 /*return*/];
            }
    ...
    it('[C260422] Should be possible to cancel a task', function () { return __awaiter(_this, void 0, void 0, function () {
        var task, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, taskPage.createNewTask()];
                ...
                case 6: return [4 /*yield*/, _a.apply(void 0, [_b.sent()]).toEqual(CONSTANTS.TASK_FILTERS.MY_TASKS)];
                case 7:
                    _b.sent();
                    return [2 /*return*/];
            }
    ...
    it('[C260423] Should be possible to save filled form', function () { return __awaiter(_this, void 0, void 0, function () {
        var task, formFields;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, taskPage.createNewTask()];
                ...
                case 6:
                    formFields = _a.sent();
                    return [4 /*yield*/, formFields.setFieldValue(protractor_1.by.id, formTextField, formFieldValue)];
                case 7:
                    _a.sent();
                    return [4 /*yield*/, formFields.refreshForm()];
                case 8:
                    _a.sent();
                    return [4 /*yield*/, formFields.checkFieldValue(protractor_1.by.id, formTextField, '')];
                case 9:
                    _a.sent();
                    return [4 /*yield*/, taskPage.tasksListPage().checkContentIsDisplayed(tasks[4])];
                case 10:
                ...
                case 11:
                    _a.sent();
                    return [4 /*yield*/, formFields.checkFieldValue(protractor_1.by.id, formTextField, formFieldValue)];
                case 12:
                    _a.sent();
                    return [4 /*yield*/, taskPage.formFields().saveForm()];
                case 13:
                    _a.sent();
                    return [4 /*yield*/, formFields.checkFieldValue(protractor_1.by.id, formTextField, formFieldValue)];
                case 14:
    ...
    it('[C260425] Should be possible to assign a user', function () { return __awaiter(_this, void 0, void 0, function () {
        var task, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, taskPage.createNewTask()];
                ...
                case 4:
                    _b.sent();
                    return [4 /*yield*/, taskPage.tasksListPage().checkTaskListIsLoaded()];
                case 5:
                    _b.sent();
                ...
                case 7:
                    _b.sent();
                    return [4 /*yield*/, taskPage.tasksListPage().checkContentIsDisplayed(tasks[5])];
                case 8:
                    _b.sent();
                ...
                case 11: return [4 /*yield*/, _a.apply(void 0, [_b.sent()]).toEqual(assigneeUserModel.firstName + ' ' + assigneeUserModel.lastName)];
                case 12:
                    _b.sent();
                    return [2 /*return*/];
            }
    ...
    it('Attach a file', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, taskPage.createNewTask()];
                case 1:
                    startTaskDialog = _a.sent();
                    return [4 /*yield*/, startTaskDialog.addName(tasks[6])];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, startTaskDialog.clickStartButton()];
                case 3:
                    _a.sent();
    ...
    it('[C260420] Should Information box be hidden when showHeaderContent property is set on false', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, taskPage.tasksListPage().checkContentIsDisplayed(showHeaderTask)];
                case 1:
                    _a.sent();
    ...
    it('[C291780] Should be displayed an error message if task name exceed 255 characters', function () { return __awaiter(_this, void 0, void 0, function () {
        var startDialog;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, taskPage.createNewTask()];
                case 1:
                    startDialog = _a.sent();
                    return [4 /*yield*/, startDialog.addName(taskName255Characters)];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, startDialog.checkStartButtonIsEnabled()];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, startDialog.addName(taskNameBiggerThen255Characters)];
                case 4:
                    _a.sent();
                    return [4 /*yield*/, startDialog.blur(startDialog.name)];
                case 5:
                    _a.sent();
                    return [4 /*yield*/, startDialog.checkValidationErrorIsDisplayed(lengthValidationError)];
                case 6:
                    _a.sent();
                    return [4 /*yield*/, startDialog.checkStartButtonIsDisabled()];
                case 7:
                    _a.sent();
                    return [2 /*return*/];
            }
...
//# sourceMappingURL=start-task-task-app.e2e.js.map