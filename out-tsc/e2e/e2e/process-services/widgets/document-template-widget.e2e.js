...
describe('Document Template widget', function () {
    ...
    var appModel;
    var app = resources.Files.FILE_FORM_ADF;
    ...
    it('[C260406] should check that the template contains assigned file ', function () { return __awaiter(_this, void 0, void 0, function () {
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = expect;
                    return [4 /*yield*/, widget.containerWidget().getFieldText(app.form_fields.container_id)];
...
//# sourceMappingURL=document-template-widget.e2e.js.map