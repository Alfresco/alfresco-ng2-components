...
describe('Header widget', function () { return __awaiter(_this, void 0, void 0, function () {
    var loginPage, processUserModel, taskPage, widget, alfrescoJsApi, appsActions, appModel, app, deployedApp, process;
    var _this = this;
    return __generator(this, function (_a) {
        loginPage = new adf_testing_1.LoginPage();
        taskPage = new tasksPage_1.TasksPage();
        widget = new adf_testing_1.Widget();
        appsActions = new apps_actions_1.AppsActions();
        app = resources.Files.WIDGET_CHECK_APP.HEADER;
        ...
        it('[C276737] Should be able to set general and visibility properties for Header widget', function () { return __awaiter(_this, void 0, void 0, function () {
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, taskPage.formFields().checkWidgetIsHidden(app.FIELD.header_id)];
                    case 1:
                        _c.sent();
                        return [4 /*yield*/, widget.checkboxWidget().clickCheckboxInput(app.FIELD.checkbox_id)];
                    case 2:
                        _c.sent();
                        return [4 /*yield*/, taskPage.formFields().checkWidgetIsVisible(app.FIELD.header_id)];
                    case 3:
                        _c.sent();
                        _a = expect;
                        return [4 /*yield*/, widget.headerWidget().getFieldLabel(app.FIELD.header_id)];
                    case 4: return [4 /*yield*/, _a.apply(void 0, [_c.sent()]).toBe('Header')];
                    case 5:
                        _c.sent();
                        _b = expect;
                        return [4 /*yield*/, taskPage.formFields().isCompleteFormButtonDisabled()];
                    case 6: return [4 /*yield*/, _b.apply(void 0, [_c.sent()]).toBeFalsy()];
                    case 7:
                        _c.sent();
                        return [2 /*return*/];
                }
...
//# sourceMappingURL=header-widget.e2e.js.map