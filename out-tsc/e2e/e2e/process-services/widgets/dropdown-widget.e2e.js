...
describe('Dropdown widget', function () {
    ...
    var appModel;
    var app = resources.Files.WIDGET_CHECK_APP.DROPDOWN;
    ...
    it('[C269051] Should be possible to set general and options properties for Dropdown widget ', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 1: return [4 /*yield*/, _a.apply(void 0, [_h.sent()]).toBeTruthy()];
                case 2:
                    _h.sent();
                    return [4 /*yield*/, widget.dropdown().selectOption('Happy')];
                case 3:
                    _h.sent();
                    _b = expect;
                    return [4 /*yield*/, widget.dropdown().getSelectedOptionText(app.FIELD.general_dropdown)];
                case 4: return [4 /*yield*/, _b.apply(void 0, [_h.sent()]).toContain('Happy')];
                case 5:
                    _h.sent();
                    _c = expect;
                    return [4 /*yield*/, taskPage.formFields().isCompleteFormButtonDisabled()];
                case 6: return [4 /*yield*/, _c.apply(void 0, [_h.sent()]).toBeFalsy()];
                case 7:
                    _h.sent();
                    return [4 /*yield*/, widget.dropdown().selectOption('Choose one')];
                case 8:
                    _h.sent();
                    _d = expect;
                    return [4 /*yield*/, widget.dropdown().getSelectedOptionText(app.FIELD.general_dropdown)];
                case 9: return [4 /*yield*/, _d.apply(void 0, [_h.sent()]).toContain('Choose one')];
                case 10:
                    _h.sent();
                    _e = expect;
                    return [4 /*yield*/, taskPage.formFields().isCompleteFormButtonDisabled()];
                case 11: return [4 /*yield*/, _e.apply(void 0, [_h.sent()]).toBeTruthy()];
                case 12:
                    _h.sent();
                    return [4 /*yield*/, widget.dropdown().selectOption('Sad')];
                case 13:
                    _h.sent();
                    _f = expect;
                    return [4 /*yield*/, widget.dropdown().getSelectedOptionText(app.FIELD.general_dropdown)];
                case 14: return [4 /*yield*/, _f.apply(void 0, [_h.sent()]).toContain('Sad')];
                case 15:
                    _h.sent();
                    _g = expect;
                    return [4 /*yield*/, taskPage.formFields().isCompleteFormButtonDisabled()];
                case 16: return [4 /*yield*/, _g.apply(void 0, [_h.sent()]).toBeFalsy()];
                case 17:
                    _h.sent();
                    return [2 /*return*/];
            }
    ...
    it('[C269052] Should be possible to set visibility properties for Dropdown widget', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, taskPage.formFields().checkWidgetIsHidden(app.FIELD.dropdown_visible)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, widget.checkboxWidget().clickCheckboxInput(app.FIELD.checkbox_id)];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, taskPage.formFields().checkWidgetIsVisible(app.FIELD.dropdown_visible)];
                case 3:
                    _a.sent();
                    return [2 /*return*/];
            }
