...
describe('People widget', function () {
    ...
    var appModel;
    var app = resources.Files.WIDGET_CHECK_APP.ADD_PEOPLE;
    ...
    it('[C260435] Should select user from People Widget', function () { return __awaiter(_this, void 0, void 0, function () {
        var admin;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, taskPage.formFields().checkWidgetIsHidden(app.FIELD.widget_id)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, widget.checkboxWidget().clickCheckboxInput(app.FIELD.checkbox_id)];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, taskPage.formFields().checkWidgetIsVisible(app.FIELD.widget_id)];
                case 3:
                    _a.sent();
                    admin = processUserModel.firstName + ' ' + processUserModel.lastName;
                    return [4 /*yield*/, widget.peopleWidget().insertUser(app.FIELD.widget_id, admin.charAt(0))];
                case 4:
                    _a.sent();
                    return [4 /*yield*/, widget.peopleWidget().checkDropDownListIsDisplayed()];
                case 5:
                    _a.sent();
                    return [4 /*yield*/, widget.peopleWidget().checkUserIsListed(admin)];
                case 6:
                    _a.sent();
                    return [4 /*yield*/, widget.peopleWidget().selectUserFromDropDown(admin)];
                case 7:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('[C274707] Should be possible to set visibility properties for People Widget', function () { return __awaiter(_this, void 0, void 0, function () {
        var admin;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, taskPage.formFields().checkWidgetIsHidden(app.FIELD.widget_id)];
...
//# sourceMappingURL=people-widget.e2e.js.map