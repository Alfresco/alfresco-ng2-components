...
describe('Date widget', function () {
    ...
    var appModel;
    var app = resources.Files.WIDGET_CHECK_APP.DATE;
    ...
    it('[C268814] Should be able to set general settings for Date widget', function () { return __awaiter(_this, void 0, void 0, function () {
        var _a, _b, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    _a = expect;
                    return [4 /*yield*/, widget.dateWidget().getDateLabel(app.FIELD.date_input)];
                case 1: return [4 /*yield*/, _a.apply(void 0, [_d.sent()]).toContain('Date')];
                case 2:
                    _d.sent();
                    _b = expect;
                    return [4 /*yield*/, taskPage.formFields().isCompleteFormButtonDisabled()];
                case 3: return [4 /*yield*/, _b.apply(void 0, [_d.sent()]).toBeTruthy()];
                case 4:
                    _d.sent();
                    return [4 /*yield*/, widget.dateWidget().setDateInput(app.FIELD.date_input, '20-10-2018')];
                case 5:
                    _d.sent();
    ...
    it('[C277234] Should be able to set advanced settings for Date widget ', function () { return __awaiter(_this, void 0, void 0, function () {
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, widget.dateWidget().setDateInput(app.FIELD.date_between_input, '20-10-2017')];
                case 1:
                    _c.sent();
                    return [4 /*yield*/, taskPage.formFields().saveForm()];
                case 2:
                    _c.sent();
                    _a = expect;
                    return [4 /*yield*/, widget.dateWidget().getErrorMessage(app.FIELD.date_between_input)];
                case 3: return [4 /*yield*/, _a.apply(void 0, [_c.sent()]).toBe('Can\'t be less than 1-10-2018')];
                case 4:
                    _c.sent();
                    return [4 /*yield*/, widget.dateWidget().clearDateInput(app.FIELD.date_between_input)];
                case 5:
                    _c.sent();
                    return [4 /*yield*/, widget.dateWidget().setDateInput(app.FIELD.date_between_input, '20-10-2019')];
                case 6:
                    _c.sent();
                    return [4 /*yield*/, taskPage.formFields().saveForm()];
                case 7:
                    ...
                    _b = expect;
                    return [4 /*yield*/, widget.dateWidget().getErrorMessage(app.FIELD.date_between_input)];
                case 8: return [4 /*yield*/, _b.apply(void 0, [_c.sent()]).toBe('Can\'t be greater than 31-10-2018')];
                case 9:
                    _c.sent();
                    return [2 /*return*/];
            }
...
//# sourceMappingURL=date-widget.e2e.js.map