...
describe('Radio Buttons Widget', function () {
    ...
    var appModel;
    var app = resources.Files.WIDGET_CHECK_APP.RADIO_BUTTONS;
    ...
    it('[C277316] Should display empty radio buttons when no preselection is configured', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, widget.checkboxWidget().clickCheckboxInput(app.FIELD.checkbox_id)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, widget.radioWidget().isSelectionClean(app.FIELD.radio_buttons_id)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('[C274704] Should be able to set visibility properties for Radio Button widget', function () { return __awaiter(_this, void 0, void 0, function () {
        var _a, _b, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0: return [4 /*yield*/, taskPage.formFields().checkWidgetIsHidden(app.FIELD.radio_buttons_id)];
                case 1:
                    _d.sent();
                    _a = expect;
                    return [4 /*yield*/, taskPage.formFields().isCompleteFormButtonDisabled()];
                case 2: return [4 /*yield*/, _a.apply(void 0, [_d.sent()]).toBeTruthy()];
                case 3:
                    _d.sent();
                ...
                case 4:
                    _d.sent();
                    _b = expect;
                    return [4 /*yield*/, widget.radioWidget().getRadioWidgetLabel(app.FIELD.radio_buttons_id)];
                case 5: return [4 /*yield*/, _b.apply(void 0, [_d.sent()]).toContain('Radio posts')];
                case 6:
                    _d.sent();
                    return [4 /*yield*/, widget.radioWidget().selectOption(app.FIELD.radio_buttons_id, 1)];
                case 7:
                    _d.sent();
                    _c = expect;
                    return [4 /*yield*/, taskPage.formFields().isCompleteFormButtonDisabled()];
...
//# sourceMappingURL=radio-buttons-widget.e2e.js.map