...
describe('Attach Folder widget', function () {
    ...
    var appModel;
    var app = resources.Files.WIDGET_CHECK_APP.ATTACH_FOLDER;
    ...
    it('[C276745] Should be possible to set visibility properties for Attach Folder Widget', function () { return __awaiter(_this, void 0, void 0, function () {
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, taskPage.formFields().checkWidgetIsHidden(app.FIELD.upload_button_id)];
                case 1:
                    _b.sent();
                    return [4 /*yield*/, widget.checkboxWidget().clickCheckboxInput(app.FIELD.checkbox_id)];
                case 2:
                    _b.sent();
                    return [4 /*yield*/, taskPage.formFields().checkWidgetIsVisible(app.FIELD.upload_button_id)];
                case 3:
                    _b.sent();
                    _a = expect;
                    return [4 /*yield*/, taskPage.formFields().isCompleteFormButtonDisabled()];
                case 4: return [4 /*yield*/, _a.apply(void 0, [_b.sent()]).toBeTruthy()];
                case 5:
                    _b.sent();
                    return [2 /*return*/];
            }
...
//# sourceMappingURL=attach-folder-widget.e2e.js.map