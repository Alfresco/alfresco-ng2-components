...
describe('Hyperlink widget', function () {
    ...
    var appModel;
    var app = resources.Files.WIDGET_CHECK_APP.HYPERLINK;
    ...
    it('[C276728] Should be able to set visibility properties for Hyperlink widget', function () { return __awaiter(_this, void 0, void 0, function () {
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, taskPage.formFields().checkWidgetIsHidden(app.FIELD.hyperlink_id)];
                case 1:
                    _c.sent();
                    return [4 /*yield*/, widget.checkboxWidget().clickCheckboxInput(app.FIELD.checkbox_id)];
                case 2:
                    _c.sent();
                    return [4 /*yield*/, taskPage.formFields().checkWidgetIsVisible(app.FIELD.hyperlink_id)];
                case 3:
                    _c.sent();
                    _a = expect;
                    return [4 /*yield*/, widget.hyperlink().getFieldLabel(app.FIELD.hyperlink_id)];
                case 4: return [4 /*yield*/, _a.apply(void 0, [_c.sent()]).toBe('Hyperlink')];
                case 5:
                    _c.sent();
                    _b = expect;
                    return [4 /*yield*/, widget.hyperlink().getFieldText(app.FIELD.hyperlink_id)];
                case 6: return [4 /*yield*/, _b.apply(void 0, [_c.sent()]).toBe('https://www.google.com/')];
                case 7:
                    _c.sent();
                    return [2 /*return*/];
            }
...
//# sourceMappingURL=hyperlink-widget.e2e.js.map