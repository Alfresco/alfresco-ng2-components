...
describe('Number widget', function () {
    ...
    var appModel;
    var app = resources.Files.WIDGET_CHECK_APP.NUMBER;
    ...
    it('[C269111] Should be able to set general properties for Number Widget', function () { return __awaiter(_this, void 0, void 0, function () {
        var _a, _b, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1: return [4 /*yield*/, _a.apply(void 0, [_e.sent()]).toBeTruthy()];
                case 2:
                    _e.sent();
                    _b = expect;
                    return [4 /*yield*/, widget.numberWidget().getNumberFieldLabel(app.FIELD.number_general)];
                case 3: return [4 /*yield*/, _b.apply(void 0, [_e.sent()]).toContain('Number General')];
                case 4:
                    _e.sent();
                    _c = expect;
                    return [4 /*yield*/, widget.numberWidget().getPlaceholder(app.FIELD.number_general)];
                case 5: return [4 /*yield*/, _c.apply(void 0, [_e.sent()]).toContain('Type a number')];
                case 6:
                    _e.sent();
                    return [4 /*yield*/, widget.numberWidget().setFieldValue(app.FIELD.number_general, 2)];
                case 7:
                    _e.sent();
                    _d = expect;
                    return [4 /*yield*/, taskPage.formFields().isCompleteFormButtonDisabled()];
                case 8: return [4 /*yield*/, _d.apply(void 0, [_e.sent()]).toBeFalsy()];
                case 9:
                    _e.sent();
                    return [2 /*return*/];
            }
    ...
    it('[C274702] Should be able to set advanced and visibility properties for Number Widget', function () { return __awaiter(_this, void 0, void 0, function () {
        var _a, _b, _c, _d, _e;
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0: return [4 /*yield*/, widget.numberWidget().setFieldValue(app.FIELD.number_general, 2)];
                case 1:
                    _f.sent();
                    return [4 /*yield*/, taskPage.formFields().checkWidgetIsHidden(app.FIELD.number_visible)];
                case 2:
                    _f.sent();
                    return [4 /*yield*/, widget.checkboxWidget().clickCheckboxInput(app.FIELD.checkbox_id)];
                case 3:
                    _f.sent();
                    return [4 /*yield*/, taskPage.formFields().checkWidgetIsVisible(app.FIELD.number_visible)];
                case 4:
                    _f.sent();
                    return [4 /*yield*/, widget.numberWidget().setFieldValue(app.FIELD.number_visible, 2)];
                case 5:
                    _f.sent();
                    _a = expect;
                    return [4 /*yield*/, widget.numberWidget().getErrorMessage(app.FIELD.number_visible)];
                case 6: return [4 /*yield*/, _a.apply(void 0, [_f.sent()]).toBe('Can\'t be less than 3')];
                case 7:
                    _f.sent();
                    _b = expect;
                    return [4 /*yield*/, taskPage.formFields().isCompleteFormButtonDisabled()];
                case 8: return [4 /*yield*/, _b.apply(void 0, [_f.sent()]).toBeTruthy()];
                case 9:
                    _f.sent();
                    return [4 /*yield*/, widget.numberWidget().clearFieldValue(app.FIELD.number_visible)];
                case 10:
                    _f.sent();
                    return [4 /*yield*/, widget.numberWidget().setFieldValue(app.FIELD.number_visible, 101)];
                case 11:
                    _f.sent();
                    _c = expect;
                    return [4 /*yield*/, widget.numberWidget().getErrorMessage(app.FIELD.number_visible)];
                case 12: return [4 /*yield*/, _c.apply(void 0, [_f.sent()]).toBe('Can\'t be greater than 100')];
                case 13:
                    _f.sent();
                    _d = expect;
                    return [4 /*yield*/, taskPage.formFields().isCompleteFormButtonDisabled()];
                case 14: return [4 /*yield*/, _d.apply(void 0, [_f.sent()]).toBeTruthy()];
                case 15:
                    _f.sent();
                    return [4 /*yield*/, widget.numberWidget().clearFieldValue(app.FIELD.number_visible)];
                case 16:
                    _f.sent();
                    return [4 /*yield*/, widget.numberWidget().setFieldValue(app.FIELD.number_visible, 4)];
                case 17:
                    _f.sent();
                    _e = expect;
                    return [4 /*yield*/, taskPage.formFields().isCompleteFormButtonDisabled()];
                case 18: return [4 /*yield*/, _e.apply(void 0, [_f.sent()]).toBeFalsy()];
                case 19:
                    _f.sent();
                    return [2 /*return*/];
            }
...
//# sourceMappingURL=number-widget.e2e.js.map