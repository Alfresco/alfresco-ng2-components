...
describe('Process Instance Details', function () {
    ...
    var appModel, process, user;
    var app = resources.Files.SIMPLE_APP_WITH_USER_FORM;
    var PROCESS_DATE_FORMAT = 'mmm d, yyyy';
    beforeAll(function () { return __awaiter(_this, void 0, void 0, function () {
        var apps, users, processModel;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    appModel = _a.sent();
                    return [4 /*yield*/, apps.startProcess(this.alfrescoJsApi, appModel, 'process')];
                case 5:
                ...
                case 11:
                    _a.sent();
                    return [4 /*yield*/, this.alfrescoJsApi.activiti.processApi.getProcessInstance(processModel.id)];
                case 12:
                    process = _a.sent();
                    return [2 /*return*/];
            }
    ...
    afterAll(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, this.alfrescoJsApi.activiti.modelsApi.deleteModel(appModel.id)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, this.alfrescoJsApi.login(protractor_1.browser.params.testConfig.adf.adminEmail, protractor_1.browser.params.testConfig.adf.adminPassword)];
                case 2:
    ...
    it('[C307031] Should display the created date in the default format', function () { return __awaiter(_this, void 0, void 0, function () {
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, processDetailsPage.checkDetailsAreDisplayed()];
                case 1:
                    _b.sent();
                    _a = expect;
                    return [4 /*yield*/, processDetailsPage.getCreated()];
                case 2: return [4 /*yield*/, _a.apply(void 0, [_b.sent()]).toEqual(dateFormat(process.started, PROCESS_DATE_FORMAT))];
                case 3:
                    _b.sent();
                    return [2 /*return*/];
            }
...
//# sourceMappingURL=process-instance-details.e2e.js.map