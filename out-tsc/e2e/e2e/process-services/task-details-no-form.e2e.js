...
describe('Task Details - No form', function () {
    var loginPage = new adf_testing_1.LoginPage();
    var navigationBarPage = new navigationBarPage_1.NavigationBarPage();
    var processUserModel;
    var app = resources.Files.NO_FORM_APP;
    ...
    beforeAll(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    importedApp = _a.sent();
                    return [4 /*yield*/, apps.startProcess(this.alfrescoJsApi, importedApp)];
                case 6:
                    _a.sent();
    ...
    it('[C289311] Should attach form and complete buttons to be displayed when no form is attached', function () { return __awaiter(_this, void 0, void 0, function () {
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, navigationBarPage.navigateToProcessServicesPage()];
                case 1: return [4 /*yield*/, (_c.sent()).goToTaskApp()];
                case 2: return [4 /*yield*/, (_c.sent()).clickTasksButton()];
                case 3:
                    _c.sent();
                    return [4 /*yield*/, taskPage.filtersPage().goToFilter(CONSTANTS.TASK_FILTERS.MY_TASKS)];
                case 4:
                    _c.sent();
                    return [4 /*yield*/, taskPage.tasksListPage().checkContentIsDisplayed(app.taskName)];
                case 5:
                    _c.sent();
                    return [4 /*yield*/, taskPage.tasksListPage().selectRow(app.taskName)];
                case 6:
                    _c.sent();
                    return [4 /*yield*/, taskPage.taskDetails().noFormIsDisplayed()];
                case 7:
                    _c.sent();
                    return [4 /*yield*/, taskPage.taskDetails().checkCompleteTaskButtonIsDisplayed()];
                case 8:
                    _c.sent();
                    return [4 /*yield*/, taskPage.taskDetails().checkCompleteTaskButtonIsEnabled()];
                case 9:
                    _c.sent();
                    return [4 /*yield*/, taskPage.taskDetails().checkAttachFormButtonIsNotDisplayed()];
                case 10:
                    _c.sent();
                    _a = expect;
...
//# sourceMappingURL=task-details-no-form.e2e.js.map