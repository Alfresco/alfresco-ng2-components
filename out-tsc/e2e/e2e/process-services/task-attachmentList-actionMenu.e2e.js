...
describe('Attachment list action menu for tasks', function () {
    ...
    var tenantId, appId, relatedContent, relatedContentId;
    var taskName = {
        active: 'Active Task',
    ...
    it('[C277311] Should be able to View /Download /Remove from Attachment List on an active task', function () { return __awaiter(_this, void 0, void 0, function () {
        var task, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 5:
                    task = _b.sent();
                    return [4 /*yield*/, task.addName(taskName.active)];
                case 6:
                    _b.sent();
                ...
                case 17: return [4 /*yield*/, _a.apply(void 0, [_b.sent()]).toBe(true)];
                case 18:
                    _b.sent();
    ...
    it('[C260236] Should be able to View /Download /Remove from Attachment List on a completed task', function () { return __awaiter(_this, void 0, void 0, function () {
        var task, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, navigationBarPage.navigateToProcessServicesPage()];
                ...
                case 5:
                    task = _b.sent();
                    return [4 /*yield*/, task.addName(taskName.completed)];
                case 6:
                    _b.sent();
                    return [4 /*yield*/, task.clickStartButton()];
                case 7:
                ...
                case 11:
                    _b.sent();
                    return [4 /*yield*/, taskPage.tasksListPage().selectRow(taskName.completed)];
                case 12:
                    _b.sent();
    ...
    it('[C260225] Should be able to upload a file in the Attachment list on Task App', function () { return __awaiter(_this, void 0, void 0, function () {
        var task;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, navigationBarPage.navigateToProcessServicesPage()];
                ...
                case 5:
                    task = _a.sent();
                    return [4 /*yield*/, task.addName(taskName.taskApp)];
                case 6:
                    _a.sent();
                    return [4 /*yield*/, task.clickStartButton()];
                case 7:
    ...
    it('[C279884] Should be able to view the empty attachment list for tasks', function () { return __awaiter(_this, void 0, void 0, function () {
        var task;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, navigationBarPage.navigateToProcessServicesPage()];
                ...
                case 5:
                    task = _a.sent();
                    return [4 /*yield*/, task.addName(taskName.emptyList)];
                case 6:
                    _a.sent();
                    return [4 /*yield*/, task.clickStartButton()];
                case 7:
    ...
    it('[C260234] Should be able to attache a file on a task on APS and check on ADF', function () { return __awaiter(_this, void 0, void 0, function () {
        var newTask, newTaskId, filePath, file;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, this.alfrescoJsApi.activiti.taskApi.createNewTask({ name: 'SHARE KNOWLEDGE' })];
                case 1:
                    newTask = _a.sent();
                    newTaskId = newTask.id;
                    filePath = path.join(protractor_1.browser.params.testConfig.main.rootPath + pngFile.location);
                    file = fs.createReadStream(filePath);
                    return [4 /*yield*/, this.alfrescoJsApi.activiti.contentApi.createRelatedContentOnTask(newTaskId, file, { 'isRelatedContent': true })];
                case 2:
                    relatedContent = _a.sent();
                ...
                case 6:
                    _a.sent();
                    return [4 /*yield*/, taskPage.tasksListPage().selectRow('SHARE KNOWLEDGE')];
                case 7:
                    _a.sent();
                    return [4 /*yield*/, attachmentListPage.checkFileIsAttached(pngFile.name)];
                case 8:
                    _a.sent();
                    return [4 /*yield*/, this.alfrescoJsApi.activiti.contentApi.deleteContent(relatedContentId)];
                case 9:
                    _a.sent();
                    return [4 /*yield*/, navigationBarPage.navigateToProcessServicesPage()];
                case 10: return [4 /*yield*/, (_a.sent()).goToTaskApp()];
                case 11: return [4 /*yield*/, (_a.sent()).clickTasksButton()];
                case 12:
                    _a.sent();
                    return [4 /*yield*/, taskPage.filtersPage().goToFilter(CONSTANTS.TASK_FILTERS.MY_TASKS)];
                case 13:
...
//# sourceMappingURL=task-attachmentList-actionMenu.e2e.js.map