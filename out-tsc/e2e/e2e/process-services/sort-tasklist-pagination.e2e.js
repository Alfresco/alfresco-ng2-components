...
describe('Task List Pagination - Sorting', function () {
    ...
    var taskNames = util_1.Util.generateSequenceFiles(10, nrOfTasks + 9, taskNameBase, '');
    var itemsPerPage = {
        five: '5',
        fiveValue: 5,
        ten: '10',
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    _a.label = 5;
                case 5:
                    if (!(i < nrOfTasks)) return [3 /*break*/, 8];
                    return [4 /*yield*/, this.alfrescoJsApi.activiti.taskApi.createNewTask({ name: taskNames[i] })];
                case 6:
                    _a.sent();
                    _a.label = 7;
                case 7:
    ...
    it('[C260308] Should be possible to sort tasks by name', function () { return __awaiter(_this, void 0, void 0, function () {
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 6:
                    _a.sent();
                    return [4 /*yield*/, taskPage.filtersPage().sortByName('ASC')];
                case 7:
                    _a.sent();
                    return [4 /*yield*/, taskPage.tasksListPage().getDataTable().waitForTableBody()];
                case 8:
                    _a.sent();
                    return [4 /*yield*/, taskPage.filtersPage().getAllRowsNameColumn().then(function (list) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, expect(JSON.stringify(list) === JSON.stringify(taskNames)).toEqual(true)];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
                ...
                case 9:
                    _a.sent();
                    return [4 /*yield*/, taskPage.filtersPage().sortByName('DESC')];
                case 10:
                    _a.sent();
                    return [4 /*yield*/, taskPage.filtersPage().getAllRowsNameColumn().then(function (list) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        taskNames.reverse();
                                        return [4 /*yield*/, expect(JSON.stringify(list) === JSON.stringify(taskNames)).toEqual(true)];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
...
//# sourceMappingURL=sort-tasklist-pagination.e2e.js.map