...
describe('Viewer', function () {
    ...
    var archiveFolderInfo = new folderModel_1.FolderModel({
    ...
    describe('Archive Folder Uploaded', function () {
        var uploadedArchives;
        var archiveFolderUploaded;
        beforeAll(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, uploadActions.createFolder(archiveFolderInfo.name, '-my-')];
                    case 1:
                        archiveFolderUploaded = _a.sent();
                        return [4 /*yield*/, uploadActions.uploadFolder(archiveFolderInfo.location, archiveFolderUploaded.entry.id)];
                    case 2:
                        uploadedArchives = _a.sent();
        ...
        afterAll(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, uploadActions.deleteFileOrFolder(archiveFolderUploaded.entry.id)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it('[C260517] Should be possible to open any Archive file', function () { return __awaiter(_this, void 0, void 0, function () {
            var _i, uploadedArchives_1, file;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, contentServicesPage.doubleClickRow('archive')];
                    case 1:
                        _a.sent();
                        _i = 0, uploadedArchives_1 = uploadedArchives;
                        _a.label = 2;
                    case 2:
                        if (!(_i < uploadedArchives_1.length)) return [3 /*break*/, 7];
                        file = uploadedArchives_1[_i];
...
//# sourceMappingURL=viewer-archive.component.e2e.js.map