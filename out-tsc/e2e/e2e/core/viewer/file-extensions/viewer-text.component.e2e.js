...
describe('Viewer', function () {
    ...
    var textFolderInfo = new folderModel_1.FolderModel({
    ...
    describe('Text Folder Uploaded', function () {
        var uploadedTexts;
        var textFolderUploaded;
        beforeAll(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, uploadActions.createFolder(textFolderInfo.name, '-my-')];
                    case 1:
                        textFolderUploaded = _a.sent();
                        return [4 /*yield*/, uploadActions.uploadFolder(textFolderInfo.location, textFolderUploaded.entry.id)];
                    case 2:
                        uploadedTexts = _a.sent();
        ...
        afterAll(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, uploadActions.deleteFileOrFolder(textFolderUploaded.entry.id)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it('[C280010] Should be possible to open any Text file', function () { return __awaiter(_this, void 0, void 0, function () {
            var _i, uploadedTexts_1, currentFile;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, contentServicesPage.doubleClickRow('text')];
                    case 1:
                        _a.sent();
                        _i = 0, uploadedTexts_1 = uploadedTexts;
                        _a.label = 2;
                    case 2:
                        if (!(_i < uploadedTexts_1.length)) return [3 /*break*/, 7];
                        currentFile = uploadedTexts_1[_i];
...
//# sourceMappingURL=viewer-text.component.e2e.js.map