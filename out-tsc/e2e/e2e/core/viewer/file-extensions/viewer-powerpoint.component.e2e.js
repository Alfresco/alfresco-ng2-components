...
describe('Viewer', function () {
    ...
    var pptFolderInfo = new folderModel_1.FolderModel({
    ...
    describe('PowerPoint Folder Uploaded', function () {
        var uploadedPpt;
        var pptFolderUploaded;
        beforeAll(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, uploadActions.createFolder(pptFolderInfo.name, '-my-')];
                    case 1:
                        pptFolderUploaded = _a.sent();
                        return [4 /*yield*/, uploadActions.uploadFolder(pptFolderInfo.location, pptFolderUploaded.entry.id)];
                    case 2:
                        uploadedPpt = _a.sent();
        ...
        afterAll(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, uploadActions.deleteFileOrFolder(pptFolderUploaded.entry.id)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it('[C280009] Should be possible to open any PowerPoint file', function () { return __awaiter(_this, void 0, void 0, function () {
            var _i, uploadedPpt_1, currentFile;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, contentServicesPage.doubleClickRow('ppt')];
                    case 1:
                        _a.sent();
                        _i = 0, uploadedPpt_1 = uploadedPpt;
                        _a.label = 2;
                    case 2:
                        if (!(_i < uploadedPpt_1.length)) return [3 /*break*/, 7];
                        currentFile = uploadedPpt_1[_i];
...
//# sourceMappingURL=viewer-powerpoint.component.e2e.js.map