...
describe('Viewer', function () {
    ...
    var excelFolderInfo = new folderModel_1.FolderModel({
    ...
    describe('Excel Folder Uploaded', function () {
        var uploadedExcels;
        var excelFolderUploaded;
        beforeAll(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, uploadActions.createFolder(excelFolderInfo.name, '-my-')];
                    case 1:
                        excelFolderUploaded = _a.sent();
                        return [4 /*yield*/, uploadActions.uploadFolder(excelFolderInfo.location, excelFolderUploaded.entry.id)];
                    case 2:
                        uploadedExcels = _a.sent();
        ...
        afterAll(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, uploadActions.deleteFileOrFolder(excelFolderUploaded.entry.id)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it('[C280008] Should be possible to open any Excel file', function () { return __awaiter(_this, void 0, void 0, function () {
            var _i, uploadedExcels_1, currentFile;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, contentServicesPage.doubleClickRow('excel')];
                    case 1:
                        _a.sent();
                        _i = 0, uploadedExcels_1 = uploadedExcels;
                        _a.label = 2;
                    case 2:
                        if (!(_i < uploadedExcels_1.length)) return [3 /*break*/, 7];
                        currentFile = uploadedExcels_1[_i];
                    ...
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, viewerPage.checkFileIsLoaded(currentFile.entry.name)];
                    case 4:
                        _a.sent();
...
//# sourceMappingURL=viewer-excel.component.e2e.js.map