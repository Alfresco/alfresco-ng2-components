...
describe('Viewer', function () {
    ...
    var otherFolderInfo = new folderModel_1.FolderModel({
    ...
    it('[C272813] Should be redirected to site when opening and closing a file in a site', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    describe('Other Folder Uploaded', function () {
        var uploadedOthers;
        var otherFolderUploaded;
        beforeAll(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, uploadActions.createFolder(otherFolderInfo.name, '-my-')];
                    case 1:
                        otherFolderUploaded = _a.sent();
                        return [4 /*yield*/, uploadActions.uploadFolder(otherFolderInfo.location, otherFolderUploaded.entry.id)];
                    case 2:
                        uploadedOthers = _a.sent();
        ...
        afterAll(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, uploadActions.deleteFileOrFolder(otherFolderUploaded.entry.id)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it('[C280012] Should be possible to open any other Document supported extension', function () { return __awaiter(_this, void 0, void 0, function () {
            var _i, uploadedOthers_1, file;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, contentServicesPage.doubleClickRow('other')];
                    case 1:
                        _a.sent();
                        _i = 0, uploadedOthers_1 = uploadedOthers;
                        _a.label = 2;
                    case 2:
                        if (!(_i < uploadedOthers_1.length)) return [3 /*break*/, 7];
                        file = uploadedOthers_1[_i];
                        if (!(file.entry.name !== '.DS_Store')) return [3 /*break*/, 6];
                        return [4 /*yield*/, contentServicesPage.doubleClickRow(file.entry.name)];
                    case 3:
                        _a.sent();
...
//# sourceMappingURL=viewer-component.e2e.js.map