...
describe('Viewer', function () {
    ...
    var wordFileInfo = new fileModel_1.FileModel({
    ...
    var pngFileShared, wordFileUploaded;
    beforeAll(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 7:
                    _a.sent();
                    return [4 /*yield*/, uploadActions.uploadFile(wordFileInfo.location, wordFileInfo.name, '-my-')];
                case 8:
                    wordFileUploaded = _a.sent();
                    return [4 /*yield*/, this.alfrescoJsApi.core.sharedlinksApi.addSharedLink({ 'nodeId': pngFileUploaded.entry.id })];
                case 9:
                    pngFileShared = _a.sent();
                    return [2 /*return*/];
            }
        });
    }); });
    afterAll(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, uploadActions.deleteFileOrFolder(wordFileUploaded.entry.id)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('[C260105] Should be able to open an image file shared via API', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, adf_testing_1.BrowserActions.getUrl(protractor_1.browser.params.testConfig.adf.url + '/preview/s/' + pngFileShared.entry.id)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, viewerPage.checkImgContainerIsDisplayed()];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, adf_testing_1.BrowserActions.getUrl(protractor_1.browser.params.testConfig.adf.url)];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, navigationBarPage.clickLogoutButton()];
                case 4:
                    _a.sent();
                    return [4 /*yield*/, adf_testing_1.BrowserActions.getUrl(protractor_1.browser.params.testConfig.adf.url + '/preview/s/' + pngFileShared.entry.id)];
                case 5:
                    _a.sent();
                    return [4 /*yield*/, viewerPage.checkImgContainerIsDisplayed()];
                case 6:
    ...
    it('[C260106] Should be able to open a Word file shared via API', function () { return __awaiter(_this, void 0, void 0, function () {
        var sharedLink;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, contentList.selectRow(wordFileInfo.name)];
                case 3:
                    _a.sent();
                ...
                case 9:
                    _a.sent();
                    return [4 /*yield*/, viewerPage.checkFileNameIsDisplayed(wordFileInfo.name)];
                case 10:
                    _a.sent();
                    return [4 /*yield*/, adf_testing_1.BrowserActions.getUrl(protractor_1.browser.params.testConfig.adf.url)];
                case 11:
...
//# sourceMappingURL=viewer-share-content.js.map