...
var monacoExtensionPage_1 = require("../../pages/adf/demo-shell/monacoExtensionPage");
...
describe('Viewer', function () {
    ...
    var monacoExtensionPage = new monacoExtensionPage_1.MonacoExtensionPage();
    var jsFileUploaded;
    var jsFileInfo = new fileModel_1.FileModel({
    ...
    beforeAll(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    _a.sent();
                    return [4 /*yield*/, uploadActions.uploadFile(jsFileInfo.location, jsFileInfo.name, '-my-')];
                case 6:
                    jsFileUploaded = _a.sent();
    ...
    afterAll(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, uploadActions.deleteFileOrFolder(jsFileUploaded.entry.id)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    describe('Viewer extension', function () {
        it('[C297698] Should be able to add an extension for code editor viewer', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, navigationBarPage.clickAboutButton()];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, monacoExtensionPage.checkMonacoPluginIsDisplayed()];
                    case 2:
                        _a.sent();
                    ...
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, contentServicesPage.checkContentIsDisplayed(jsFileInfo.name)];
                    case 5:
                        _a.sent();
                        return [4 /*yield*/, contentServicesPage.doubleClickRow(jsFileInfo.name)];
                    case 6:
                        _a.sent();
                        return [4 /*yield*/, viewerPage.checkCodeViewerIsDisplayed()];
                    case 7:
                        _a.sent();
                        return [2 /*return*/];
                }
...
//# sourceMappingURL=viewer-extension.e2e.js.map