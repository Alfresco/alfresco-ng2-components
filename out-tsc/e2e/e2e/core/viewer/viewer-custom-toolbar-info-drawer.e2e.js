...
describe('Viewer', function () {
    ...
    afterAll(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, uploadActions.deleteFileOrFolder(txtFileUploaded.entry.id)];
                case 1:
                    _a.sent();
    ...
    beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, contentServicesPage.doubleClickRow(txtFileUploaded.entry.name)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('[C260096] Should the Viewer able to accept a customToolbar', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, viewerPage.clickLeftSidebarButton()];
                case 1:
                    _a.sent();
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, viewerPage.enableCustomToolbar()];
                case 4:
                    _a.sent();
                    return [4 /*yield*/, viewerPage.checkCustomToolbarIsDisplayed()];
                case 5:
                    _a.sent();
                    return [4 /*yield*/, viewerPage.disableCustomToolbar()];
                case 6:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('[C260097] Should the viewer able to show a custom info-drawer when the sidebarTemplate is set', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, viewerPage.clickOnTab('Comments')];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, viewerPage.checkTabIsActive('Comments')];
                case 4:
                    _a.sent();
                    return [4 /*yield*/, viewerPage.clickOnTab('Properties')];
                case 5:
                    _a.sent();
                    return [4 /*yield*/, viewerPage.checkTabIsActive('Properties')];
                case 6:
                    _a.sent();
                    return [4 /*yield*/, viewerPage.clickOnTab('Versions')];
                case 7:
                    _a.sent();
                    return [4 /*yield*/, viewerPage.checkTabIsActive('Versions')];
                case 8:
                    _a.sent();
                    return [2 /*return*/];
            }
...
//# sourceMappingURL=viewer-custom-toolbar-info-drawer.e2e.js.map