...
describe('Process filters cloud', function () {
    describe('Process Filters', function () {
        ...
        var queryService;
        var runningProcess, completedProcess, testUser, groupInfo;
        var candidateBaseApp = resources.ACTIVITI7_APPS.CANDIDATE_BASE_APP.name;
        beforeAll(function () { return __awaiter(_this, void 0, void 0, function () {
            var processDefinition, task, claimedTask;
        ...
        it('[C290021] Should be able to view default filters', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, processCloudDemoPage.completedProcessesFilter().checkProcessFilterIsDisplayed()];
                    case 1:
                        _a.sent();
        ...
        it('[C290043] Should display process in Running Processes List when process is started', function () { return __awaiter(_this, void 0, void 0, function () {
            var _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0: return [4 /*yield*/, processCloudDemoPage.runningProcessesFilter().clickProcessFilter()];
                    case 1:
                        _d.sent();
                        return [4 /*yield*/, processCloudDemoPage.runningProcessesFilter().checkProcessFilterIsDisplayed()];
                    case 2:
                    ...
                    case 3: return [4 /*yield*/, _a.apply(void 0, [_d.sent()]).toBe('Running Processes')];
                    case 4:
                        _d.sent();
                    ...
                    case 7:
                        ...
                        _b = expect;
                        return [4 /*yield*/, processCloudDemoPage.getActiveFilterName()];
                    case 8: return [4 /*yield*/, _b.apply(void 0, [_d.sent()]).toBe('Completed Processes')];
                    case 9:
                        _d.sent();
                        return [4 /*yield*/, processCloudDemoPage.processListCloudComponent().checkContentIsNotDisplayedById(runningProcess.entry.id)];
                    case 10:
                        _d.sent();
                    ...
                    case 12:
                        ...
                        _c = expect;
                        return [4 /*yield*/, processCloudDemoPage.getActiveFilterName()];
                    case 13: return [4 /*yield*/, _c.apply(void 0, [_d.sent()]).toBe('All Processes')];
                    case 14:
                        _d.sent();
                        return [4 /*yield*/, processCloudDemoPage.processListCloudComponent().checkContentIsDisplayedById(runningProcess.entry.id)];
                    case 15:
        ...
        it('[C290044] Should display process in Completed Processes List when process is completed', function () { return __awaiter(_this, void 0, void 0, function () {
            var _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0: return [4 /*yield*/, processCloudDemoPage.runningProcessesFilter().clickProcessFilter()];
                    ...
                    case 4:
                        _d.sent();
                        return [4 /*yield*/, processCloudDemoPage.processListCloudComponent().checkContentIsNotDisplayedById(completedProcess.entry.id)];
                    case 5:
                        _d.sent();
                        return [4 /*yield*/, processCloudDemoPage.completedProcessesFilter().clickProcessFilter()];
                    case 6:
...
//# sourceMappingURL=process-filters-cloud.e2e.js.map