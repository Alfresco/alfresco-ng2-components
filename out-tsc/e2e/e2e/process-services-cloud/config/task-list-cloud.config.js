...
var TaskListCloudConfiguration = /** @class */ (function () {
    function TaskListCloudConfiguration() {
    }
    TaskListCloudConfiguration.prototype.getConfiguration = function () {
        return {
            'presets': {
                'default': [
                    {
    ...
    return TaskListCloudConfiguration;
}());
exports.TaskListCloudConfiguration = TaskListCloudConfiguration;
//# sourceMappingURL=task-list-cloud.config.js.map