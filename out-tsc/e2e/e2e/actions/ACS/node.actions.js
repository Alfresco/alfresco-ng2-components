...
var NodeActions = /** @class */ (function () {
    function NodeActions() {
    }
    NodeActions.prototype.lockNode = function (alfrescoJsApi, nodeId, allowOwner) {
        return alfrescoJsApi.nodes.lockNode(nodeId, {
            type: allowOwner ? 'ALLOW_OWNER_CHANGES' : 'FULL',
            lifetime: 'PERSISTENT'
        });
    };
    NodeActions.prototype.getNodesDisplayed = function (alfrescoJsApi, idList, numberOfElements) {
        return __awaiter(this, void 0, void 0, function () {
            var promises, nodeList, i;
