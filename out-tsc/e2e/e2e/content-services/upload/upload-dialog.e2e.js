...
describe('Upload component', function () {
    ...
    afterEach(function () { return __awaiter(_this, void 0, void 0, function () {
        var nbResults, nodesPromise, _i, nodesPromise_1, node, nodeId;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, contentServicesPage.numberOfResultsDisplayed()];
                case 1:
                    nbResults = _a.sent();
                    if (!(nbResults > 1)) return [3 /*break*/, 7];
                    return [4 /*yield*/, contentServicesPage.getElementsDisplayedId()];
                case 2:
                    nodesPromise = _a.sent();
                    _i = 0, nodesPromise_1 = nodesPromise;
                    _a.label = 3;
                case 3:
                    if (!(_i < nodesPromise_1.length)) return [3 /*break*/, 7];
                    node = nodesPromise_1[_i];
                    return [4 /*yield*/, node];
                case 4:
                    nodeId = _a.sent();
    ...
    it('[C291902] Should be shown upload counter display in dialog box', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 5: return [4 /*yield*/, _a.apply(void 0, [_b.sent()]).toEqual('Uploaded 1 / 1')];
                case 6:
                    _b.sent();
                    return [4 /*yield*/, uploadDialog.checkCloseButtonIsDisplayed()];
                case 7:
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    ...
                    _a = expect;
                    return [4 /*yield*/, uploadDialog.getTitleText()];
                case 5: return [4 /*yield*/, _a.apply(void 0, [_b.sent()]).toEqual('Upload canceled')];
                case 6:
                    _b.sent();
                    return [4 /*yield*/, uploadDialog.clickOnCloseButton()];
                case 7:
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 5:
                    ...
                    _a = expect;
                    return [4 /*yield*/, uploadDialog.getTitleText()];
                case 6: return [4 /*yield*/, _a.apply(void 0, [_b.sent()]).toEqual('Uploaded 4 / 4')];
                case 7:
                    _b.sent();
                    return [4 /*yield*/, uploadDialog.clickOnCloseButton()];
                case 8:
...
//# sourceMappingURL=upload-dialog.e2e.js.map