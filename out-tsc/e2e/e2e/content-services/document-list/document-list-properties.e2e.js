...
describe('Document List Component - Properties', function () {
    ...
    describe('Allow drop files property', function () {
        beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, uploadActions.createFolder('parentFolder', '-my-')];
                    case 4:
                        parentFolder = _a.sent();
                        return [4 /*yield*/, uploadActions.createFolder('subFolder', parentFolder.entry.id)];
                    case 5:
                        subFolder = _a.sent();
        ...
        afterEach(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, uploadActions.deleteFileOrFolder(subFolder.entry.id)];
                    case 2:
                        _a.sent();
        ...
        it('[C299154] Should disallow upload content on a folder row if allowDropFiles is false', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, contentServicesPage.disableDropFilesInAFolder()];
                    case 3:
                        _a.sent();
                        dragAndDropArea = contentServicesPage.getRowByName(subFolder.entry.name);
                        dragAndDrop = new drop_actions_1.DropActions();
                        return [4 /*yield*/, dragAndDrop.dropFile(dragAndDropArea, pngFile.location)];
                    case 4:
                        _a.sent();
        ...
        it('[C91319] Should allow upload content on a folder row if allowDropFiles is true', function () { return __awaiter(_this, void 0, void 0, function () {
            var dragAndDropArea, dragAndDrop;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, navigationBar.clickContentServicesButton()];
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, contentServicesPage.enableDropFilesInAFolder()];
                    case 3:
                        _a.sent();
                        dragAndDropArea = contentServicesPage.getRowByName(subFolder.entry.name);
                        dragAndDrop = new drop_actions_1.DropActions();
...
//# sourceMappingURL=document-list-properties.e2e.js.map