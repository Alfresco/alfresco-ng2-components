...
var Util = /** @class */ (function () {
     ...
     */
    Util.generateSequenceFiles = function (startIndex, endIndex, baseName, extension) {
        var fileNames = [];
     ...
     */
    Util.arrayContainsArray = function (superset, subset) {
        if (0 === subset.length) {
            return false;
        }
    ...
    Util.openNewTabInBrowser = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, protractor_1.browser.executeScript("window.open('about: blank', '_blank');")];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Util.switchToWindowHandler = function (windowNumber) {
        return __awaiter(this, void 0, void 0, function () {
            var handles;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        handles = _a.sent();
                        return [4 /*yield*/, protractor_1.browser.switchTo().window(handles[windowNumber])];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
