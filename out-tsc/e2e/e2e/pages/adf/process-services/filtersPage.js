...
var FiltersPage = /** @class */ (function () {
    ...
    FiltersPage.prototype.getActiveFilter = function () {
    ...
    FiltersPage.prototype.goToFilter = function (filterName) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, adf_testing_2.BrowserActions.clickExecuteScript("span[data-automation-id=\"" + filterName + "_filter\"]")];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    FiltersPage.prototype.sortByName = function (sortOrder) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    FiltersPage.prototype.getAllRowsNameColumn = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
...
//# sourceMappingURL=filtersPage.js.map