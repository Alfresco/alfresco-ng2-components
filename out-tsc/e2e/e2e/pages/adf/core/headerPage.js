...
var HeaderPage = /** @class */ (function () {
    ...
    HeaderPage.prototype.checkShowMenuCheckBoxIsDisplayed = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, adf_testing_1.BrowserVisibility.waitUntilElementIsVisible(this.checkBox)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    HeaderPage.prototype.checkChooseHeaderColourIsDisplayed = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, adf_testing_1.BrowserVisibility.waitUntilElementIsVisible(this.headerColor)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    HeaderPage.prototype.checkChangeTitleIsDisplayed = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, adf_testing_1.BrowserVisibility.waitUntilElementIsVisible(this.titleInput)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    HeaderPage.prototype.checkChangeUrlPathIsDisplayed = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, adf_testing_1.BrowserVisibility.waitUntilElementIsVisible(this.iconInput)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    HeaderPage.prototype.clickShowMenuButton = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        checkBox = protractor_1.element(protractor_1.by.css('mat-checkbox'));
                        return [4 /*yield*/, adf_testing_1.BrowserActions.click(checkBox.get(0))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, adf_testing_1.BrowserActions.click(headerColor)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    HeaderPage.prototype.addTitle = function (title) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, adf_testing_1.BrowserActions.click(this.titleInput)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, adf_testing_1.BrowserActions.clearSendKeys(this.titleInput, title)];
                    case 2:
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, adf_testing_1.BrowserVisibility.waitUntilElementIsVisible(icon)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    HeaderPage.prototype.addIcon = function (url) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, adf_testing_1.BrowserActions.click(this.iconInput)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, adf_testing_1.BrowserActions.clearSendKeys(this.iconInput, url)];
                    case 2:
                        _a.sent();
    ...
    HeaderPage.prototype.checkHexColorInputIsDisplayed = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, adf_testing_1.BrowserVisibility.waitUntilElementIsVisible(this.hexColorInput)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    HeaderPage.prototype.checkLogoHyperlinkInputIsDisplayed = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, adf_testing_1.BrowserVisibility.waitUntilElementIsVisible(this.logoHyperlinkInput)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    HeaderPage.prototype.checkLogoTooltipInputIsDisplayed = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, adf_testing_1.BrowserVisibility.waitUntilElementIsVisible(this.logoTooltipInput)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    HeaderPage.prototype.addHexCodeColor = function (hexCode) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, adf_testing_1.BrowserActions.click(this.hexColorInput)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.hexColorInput.sendKeys(hexCode)];
                    case 2:
                        _a.sent();
    ...
    HeaderPage.prototype.addLogoHyperlink = function (hyperlink) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, adf_testing_1.BrowserActions.click(this.logoHyperlinkInput)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.logoHyperlinkInput.sendKeys(hyperlink)];
                    case 2:
                        _a.sent();
    ...
    HeaderPage.prototype.addLogoTooltip = function (tooltip) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, adf_testing_1.BrowserActions.click(this.logoTooltipInput)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.logoTooltipInput.sendKeys(tooltip)];
                    case 2:
                        _a.sent();
    ...
    HeaderPage.prototype.sideBarPositionStart = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, adf_testing_1.BrowserActions.click(this.positionStart)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    HeaderPage.prototype.sideBarPositionEnd = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, adf_testing_1.BrowserActions.click(this.positionEnd)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    HeaderPage.prototype.checkSidebarPositionStart = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, adf_testing_1.BrowserVisibility.waitUntilElementIsVisible(this.sideBarPositionLeft)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    HeaderPage.prototype.checkSidebarPositionEnd = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, adf_testing_1.BrowserVisibility.waitUntilElementIsVisible(this.sideBarPositionRight)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
