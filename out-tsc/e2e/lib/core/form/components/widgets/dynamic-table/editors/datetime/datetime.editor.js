...
var DateTimeEditorComponent = /** @class */ (function () {
    ...
    DateTimeEditorComponent.prototype.ngOnInit = function () {
        ...
        this.value = moment_es6_1.default(this.table.getCellValue(this.row, this.column), this.DATE_TIME_FORMAT);
    };
    ...
    DateTimeEditorComponent.prototype.onDateChanged = function (newDateValue) {
        if (newDateValue && newDateValue.value) {
            var newValue = moment_es6_1.default(newDateValue.value, this.DATE_TIME_FORMAT);
            this.row.value[this.column.id] = newDateValue.value.format(this.DATE_TIME_FORMAT);
            this.value = newValue;
            this.table.flushValue();
        }
        else if (newDateValue) {
            var newValue = moment_es6_1.default(newDateValue, this.DATE_TIME_FORMAT);
            this.value = newValue;
    ...
    ], DateTimeEditorComponent.prototype, "table", void 0);
    __decorate([
        core_1.Input(),
        __metadata("design:type", Object)
    ], DateTimeEditorComponent.prototype, "row", void 0);
    __decorate([
        core_1.Input(),
        __metadata("design:type", Object)
    ], DateTimeEditorComponent.prototype, "column", void 0);
