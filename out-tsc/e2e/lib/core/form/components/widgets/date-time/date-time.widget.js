...
var DateTimeWidgetComponent = /** @class */ (function (_super) {
    ...
    DateTimeWidgetComponent.prototype.ngOnInit = function () {
        ...
        if (this.field) {
            if (this.field.minValue) {
                this.minDate = moment_es6_1.default(this.field.minValue, 'YYYY-MM-DDTHH:mm:ssZ');
            }
            if (this.field.maxValue) {
                this.maxDate = moment_es6_1.default(this.field.maxValue, 'YYYY-MM-DDTHH:mm:ssZ');
            }
        }
        this.displayDate = moment_es6_1.default(this.field.value, this.field.dateDisplayFormat)
            .add(moment_es6_1.default(this.field.value, this.field.dateDisplayFormat).utcOffset(), 'minutes');
    };
    ...
    DateTimeWidgetComponent = __decorate([
        core_1.Component({
            providers: [
...
//# sourceMappingURL=date-time.widget.js.map