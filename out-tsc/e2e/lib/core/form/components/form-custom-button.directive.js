...
var StartFormCustomButtonDirective = /** @class */ (function () {
    ...
    StartFormCustomButtonDirective = __decorate([
        core_1.Directive({ selector: '[adf-form-custom-button], [form-custom-button]' })
    ], StartFormCustomButtonDirective);
    return StartFormCustomButtonDirective;
}());
exports.StartFormCustomButtonDirective = StartFormCustomButtonDirective;
//# sourceMappingURL=form-custom-button.directive.js.map