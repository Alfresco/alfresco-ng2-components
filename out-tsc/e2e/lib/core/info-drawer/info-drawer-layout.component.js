...
var InfoDrawerTitleDirective = /** @class */ (function () {
    ...
    InfoDrawerTitleDirective = __decorate([
        core_1.Directive({ selector: '[adf-info-drawer-title], [info-drawer-title]' })
...
var InfoDrawerButtonsDirective = /** @class */ (function () {
    ...
    InfoDrawerButtonsDirective = __decorate([
        core_1.Directive({ selector: '[adf-info-drawer-buttons], [info-drawer-buttons]' })
...
var InfoDrawerContentDirective = /** @class */ (function () {
    ...
    InfoDrawerContentDirective = __decorate([
        core_1.Directive({ selector: '[adf-info-drawer-content], [info-drawer-content]' })
    ], InfoDrawerContentDirective);
    return InfoDrawerContentDirective;
}());
exports.InfoDrawerContentDirective = InfoDrawerContentDirective;
//# sourceMappingURL=info-drawer-layout.component.js.map