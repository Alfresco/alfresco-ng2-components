...
var BpmUserService = /** @class */ (function () {
    ...
    BpmUserService.prototype.getCurrentUserInfo = function () {
        var _this = this;
        return rxjs_1.from(this.apiService.getInstance().activiti.profileApi.getProfile())
            .pipe(operators_1.map(function (userRepresentation) {
            return new bpm_user_model_1.BpmUserModel(userRepresentation);
...
//# sourceMappingURL=bpm-user.service.js.map