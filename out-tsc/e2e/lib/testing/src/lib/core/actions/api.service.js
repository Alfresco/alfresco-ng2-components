...
var ApiService = /** @class */ (function () {
    function ApiService(clientId, host, hostSso, provider) {
        ...
        this.apiService = new js_api_1.AlfrescoApiCompatibility(this.config);
    }
    ...
    ApiService.prototype.performBpmOperation = function (path, method, queryParams, postBody) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ApiService.prototype.performIdentityOperation = function (path, method, queryParams, postBody) {
        return __awaiter(this, void 0, void 0, function () {
            var uri, pathParams, formParams, contentTypes, accepts, headerParams;
            return __generator(this, function (_a) {
