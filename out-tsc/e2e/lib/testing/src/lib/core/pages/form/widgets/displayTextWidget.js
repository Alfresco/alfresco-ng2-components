...
var DisplayTextWidget = /** @class */ (function () {
    function DisplayTextWidget() {
        this.formFields = new formFields_1.FormFields();
        this.labelLocator = protractor_1.by.css('div[class*="adf-display-text-widget"]');
        this.inputLocator = protractor_1.by.css('input');
    }
    DisplayTextWidget.prototype.getFieldLabel = function (fieldId) {
        return this.formFields.getFieldLabel(fieldId, this.labelLocator);
    };
    DisplayTextWidget.prototype.getFieldValue = function (fieldId) {
        return this.formFields.getFieldValue(fieldId, this.inputLocator);
    };
    DisplayTextWidget.prototype.getFieldText = function (fieldId) {
...
//# sourceMappingURL=displayTextWidget.js.map