...
var EditTaskFilterDialogPage = /** @class */ (function () {
    function EditTaskFilterDialogPage() {
        this.componentElement = protractor_1.element(protractor_1.by.css('adf-cloud-task-filter-dialog'));
        this.title = protractor_1.element(protractor_1.by.id('adf-task-filter-dialog-title'));
    ...
    EditTaskFilterDialogPage.prototype.clickOnSaveButton = function () {
    ...
    EditTaskFilterDialogPage.prototype.checkSaveButtonIsEnabled = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    EditTaskFilterDialogPage.prototype.clickOnCancelButton = function () {
        return __awaiter(this, void 0, void 0, function () {
            var cancelButton;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    EditTaskFilterDialogPage.prototype.checkCancelButtonIsEnabled = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    EditTaskFilterDialogPage.prototype.getFilterName = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    EditTaskFilterDialogPage.prototype.setFilterName = function (filterName) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    EditTaskFilterDialogPage.prototype.clearFilterName = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    EditTaskFilterDialogPage.prototype.getTitle = function () {
        return browser_actions_1.BrowserActions.getText(this.title);
    };
    return EditTaskFilterDialogPage;
}());
exports.EditTaskFilterDialogPage = EditTaskFilterDialogPage;
//# sourceMappingURL=edit-task-filter-dialog.page.js.map