...
import { SnowboundViewerModule } from 'ng2-snowbound-viewer';
...
@Component({
    ...
    template: `
        ...
        <div *ngIf="!authenticated" style="color:#FF2323">
            Authentication failed to ip {{ ecmHost }} with user: admin, admin, you can still try to add a valid ticket
            to perform
            operations.
        </div>
        <hr>
        ...
        <div class="container" *ngIf="authenticated">
            <snowbound-viewer *ngIf="fileNodeId"
                              [showViewer]="true"
                              [overlayMode]="true"
