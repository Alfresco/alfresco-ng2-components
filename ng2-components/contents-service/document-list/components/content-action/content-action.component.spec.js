...
var content_action_component_1 = require('./content-action.component');
...
describe('ContentAction', function () {
  ...
  beforeEach(function () {
    ...
    documentList = new document_list_component_1.DocumentListComponent(documentServiceMock, null, null);
  ...
  it('should register within parent actions list', function () {
    ...
    var action = new content_action_component_1.ContentActionComponent(actionList, null, null);
    action.ngOnInit();
  ...
  it('should get action handler from document actions service', function () {
    ...
    var action = new content_action_component_1.ContentActionComponent(actionList, documentActions, null);
    action.target = 'document';
  ...
  it('should get action handler from folder actions service', function () {
    ...
    var action = new content_action_component_1.ContentActionComponent(actionList, null, folderActions);
  ...
  it('should require target to get system handler', function () {
    ...
    var action = new content_action_component_1.ContentActionComponent(actionList, documentActions, folderActions);
    action.handler = '<handler>';
    action.ngOnInit();
    expect(documentList.actions.length).toBe(1);
  ...
  it('should require action list to register action with', function () {
    ...
    action = new content_action_component_1.ContentActionComponent(null, null, null);
    expect(action.register()).toBeFalsy();
  });
});  //# sourceMappingURL=content-action.component.spec.js.map
