    ...
    return {
        ...
        execute: function() {
            ...
            UploadService = (function () {
                 ...
                 */
                UploadService.prototype.uploadFilesInTheQueue = function (directory, elementEmit) {
                    var _this = this;
                    ...
                    filesToUpload.forEach(function (uploadingFileModel) {
                        ...
                        _this.uploadFile(uploadingFileModel, directory, elementEmit);
                    });
                };
                ;
                /**
                 ...
                 */
                UploadService.prototype._configureXMLHttpRequest = function (uploadingFileModel, elementEmit) {
                    var _this = this;
                 ...
                 *
                 */
                UploadService.prototype.uploadFile = function (uploadingFileModel, directory, elementEmit) {
                    var _this = this;
