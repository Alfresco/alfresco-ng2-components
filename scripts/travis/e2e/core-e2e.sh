...
./node_modules/@alfresco/adf-cli/bin/adf-cli check-ps-env.js --host "$E2E_HOST" -u "$E2E_USERNAME" -p "$E2E_PASSWORD" || exit 1
./node_modules/@alfresco/adf-cli/bin/adf-cli check-cs-env.js --host "$E2E_HOST" -u "$E2E_USERNAME" -p "$E2E_PASSWORD" || exit 1
