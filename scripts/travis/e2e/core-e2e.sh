...
then
    ...
    ./test-e2e-lib.sh -host localhost:4200 -proxy "$E2E_HOST" -u "$E2E_USERNAME" -p "$E2E_PASSWORD" -e "$E2E_EMAIL" --folder core --skip-lint -save --use-dist --seleniumServer "$SELENIUM_HOST"|| exit 1;
fi;
