...
describe('TaskHeaderComponent', () => {
    ...
    it('should display priority', () => {
        ...
        component.ngOnChanges({});
        fixture.detectChanges();
        let formNameEl = fixture.debugElement.query(By.css('[data-automation-id="header-priority"] .adf-property-value'));
        expect(formNameEl.nativeElement.innerText.trim()).toBe('27');
    });
