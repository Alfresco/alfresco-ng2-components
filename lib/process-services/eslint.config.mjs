...
export default defineConfig([
    ...
    },
    {
        ...
        rules: {
            ...
            '@angular-eslint/component-selector': ['error', { type: 'element', prefix: 'adf', style: 'kebab-case' }],
            '@angular-eslint/directive-selector': ['error', { type: 'attribute', prefix: 'adf', style: 'camelCase' }],
