...
module.exports = function (config) {
    config.set({
        ...
        files: [
            { pattern: 'node_modules/pdfjs-dist/legacy/build/pdf.mjs', included: true, watched: false, served: true, type: 'module' },
            { pattern: 'node_modules/pdfjs-dist/legacy/build/pdf.mjs.map', included: true, watched: false, type: 'js' },
            { pattern: 'node_modules/pdfjs-dist/legacy/build/pdf.worker.mjs', included: true, watched: false, served: true, type: 'module' },
            { pattern: 'node_modules/pdfjs-dist/legacy/build/pdf.worker.mjs.map', included: true, watched: false, type: 'js' },
            { pattern: 'node_modules/pdfjs-dist/legacy/build/pdf.worker.min.mjs', included: true, watched: false, served: true, type: 'module' },
            { pattern: 'node_modules/pdfjs-dist/web/pdf_viewer.mjs', included: true, watched: false, type: 'module' },
            {
