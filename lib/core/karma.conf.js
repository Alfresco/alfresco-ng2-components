...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            // pdf-js
            {pattern: 'node_modules/pdfjs-dist/build/pdf.js.map', included: true, watched: false, served: true},
            {pattern: 'node_modules/pdfjs-dist/build/pdf.js', included: true, watched: false},
            {pattern: 'node_modules/pdfjs-dist/build/pdf.worker.js', included: true, watched: false, served: true},
            {pattern: 'node_modules/pdfjs-dist/build/pdf.worker.js.map', included: true, watched: false, served: true},
