...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            {pattern: './viewer/assets/fake-test-file.pdf', included: false, served: true, watched: false},
            {pattern: './viewer/assets/fake-test-file.txt', included: false, served: true, watched: false},
            {
                pattern: './viewer/assets/fake-test-password-file.pdf',
                included: false,
                served: true,
                watched: false
            }
        ...
        proxies: {
            ...
            '/assets/adf-core/i18n/en.json': '/base/i18n/en.json',
