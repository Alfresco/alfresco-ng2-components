...
export const dateColumns = [{ type: 'date', key: 'createdOn', title: 'Created On', format: 'medium' }];
...
export const locationColumns = [{ format: '/somewhere', type: 'location', key: 'path', title: 'Location' }];
