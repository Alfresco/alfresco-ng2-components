...
describe('ViewerComponent', () => {
    ...
    beforeEach(() => {
        ...
        component.urlFile = 'base/src/assets/test-file.pdf';
        ...
        describe('Overlay mode true', () => {
            ...
            it('should Name File be present if is overlay mode ', () => {
                component.ngOnChanges(null).then(() => {
                    fixture.detectChanges();
                    expect(element.querySelector('.adf-viewer-filename').innerHTML).toEqual('test-file.pdf');
                });
            });
    ...
    describe('display name property override by urlFile', () => {
        ...
        it('should use the urlFile name if displayName is NOT set and urlFile is set' , (done) => {
            ...
            component.ngOnChanges(null).then(() => {
                fixture.detectChanges();
                expect(element.querySelector('#adf-viewer-display-name').textContent).toEqual('test-file.pdf');
                done();
            });
        });
    });
