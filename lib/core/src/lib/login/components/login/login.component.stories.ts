...
const meta: Meta<LoginStoryArgs> = {
    ...
    argTypes: {
        ...
        copyrightText: {
            ...
            defaultValue: '\u00A9 2005-2026 Hyland Software, Inc. and its affiliates. All rights reserved.',
            table: {
                type: { summary: 'string' },
                defaultValue: { summary: '\u00A9 2005-2026 Hyland Software, Inc. and its affiliates. All rights reserved.' }
            }
        },
        fieldsValidation: {
            control: 'object',
