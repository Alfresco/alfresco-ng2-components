...
describe('PathMatcher', () => {
    describe('match', () => {
        it('should return true if path is exactly the same like pattern', () => {
            assert.equal(PathMatcher.match('public-url', 'public-url'), true);
        });

        it('should return false if path is not equal to pattern', () => {
            assert.equal(PathMatcher.match('some-public-url', 'public-url'), false);
        });

        it('should return true if absolute path is equal to absolute path', () => {
            assert.equal(PathMatcher.match('https://some-public-url', 'https://some-public-url'), true);
        });

        it('should return true if path matches pattern containing double and single *', () => {
            assert.equal(PathMatcher.match('https://some-public-url/123/path', '**/some-public-url/*/path'), true);
        });

        it('should return true if path matches to pattern after replacing ** with multiple parts at the beginning', () => {
            assert.equal(PathMatcher.match('https://test/other-test/some-public-url/path', '**/some-public-url/path'), true);
        });
        ...
        it('should return true if path matches to pattern after replacing ** with multiple parts at the end', () => {
            assert.equal(PathMatcher.match('https://some-public-url/path/test/other-test', 'https://some-public-url/path/**'), true);
        });

        it('should return true if path matches to pattern after replacing ** with none parts at the end', () => {
            assert.equal(PathMatcher.match('https://some-public-url/path/', 'https://some-public-url/path/**'), true);
        });

        it('should return false if path does not match to pattern after replacing ** with none parts at the end and cuts last /', () => {
            assert.equal(PathMatcher.match('https://some-public-url/path', 'https://some-public-url/path/**'), false);
        });

        it('should return true if path matches to pattern after replacing ** with multiple parts in the middle', () => {
            assert.equal(PathMatcher.match('https://some-public-url/test/other-test/path', 'https://some-public-url/**/path'), true);
        });
        ...
        it('should return false if path does not match to pattern with **', () => {
            assert.equal(PathMatcher.match('https://some-public-url/', 'https://some-public-url/**/path'), false);
        });

        it('should return false if path has more than one part as replacement for * in the middle of pattern', () => {
            assert.equal(PathMatcher.match('https://some-public-url/123/test/path', 'https://some-public-url/*/path'), false);
        });
        ...
        it('should return true if path matches to pattern containing * at the end', () => {
            assert.equal(PathMatcher.match('https://some-public-url/path/test', 'https://some-public-url/path/*'), true);
        });
        ...
        it('should return false if path has more than one part as replacement for * at the end of pattern', () => {
            assert.equal(PathMatcher.match('https://some-public-url/path/test/other-test', 'https://some-public-url/path/*'), false);
        });
        ...
        it('should return false if path starts with https:// and * is at the beginning of pattern', () => {
            assert.equal(PathMatcher.match('https://some-public-url/path/test', '*/some-public-url/path'), false);
        });
    });
});
