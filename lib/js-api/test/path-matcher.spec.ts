...
describe('PathMatcher', () => {
    describe('match', () => {
        ...
        it('should return true if absolute path is equal to absolute path', () => {
            expect(PathMatcher.match('https://some-public-url', 'https://some-public-url')).be.true;
        });

        it('should return true if path matches pattern containing double and single *', () => {
            expect(PathMatcher.match('https://some-public-url/123/path', '**/some-public-url/*/path')).be.true;
        });

        it('should return true if path matches to pattern after replacing ** with multiple parts at the beginning', () => {
            expect(PathMatcher.match('https://test/other-test/some-public-url/path', '**/some-public-url/path')).be.true;
        });
        ...
        it('should return true if path matches to pattern after replacing ** with multiple parts at the end', () => {
            expect(PathMatcher.match('https://some-public-url/path/test/other-test', 'https://some-public-url/path/**')).be.true;
        });

        it('should return true if path matches to pattern after replacing ** with none parts at the end', () => {
            expect(PathMatcher.match('https://some-public-url/path/', 'https://some-public-url/path/**')).be.true;
        });

        it('should return false if path does not match to pattern after replacing ** with none parts at the end and cuts last /', () => {
            expect(PathMatcher.match('https://some-public-url/path', 'https://some-public-url/path/**')).be.false;
        });

        it('should return true if path matches to pattern after replacing ** with multiple parts in the middle', () => {
            expect(PathMatcher.match('https://some-public-url/test/other-test/path', 'https://some-public-url/**/path')).be.true;
        });
        ...
        it('should return false if path does not match to pattern with **', () => {
            expect(PathMatcher.match('https://some-public-url/', 'https://some-public-url/**/path')).be.false;
        });

        it('should return false if path has more than one part as replacement for * in the middle of pattern', () => {
            expect(PathMatcher.match('https://some-public-url/123/test/path', 'https://some-public-url/*/path')).be.false;
        });
        ...
        it('should return true if path matches to pattern containing * at the end', () => {
            expect(PathMatcher.match('https://some-public-url/path/test', 'https://some-public-url/path/*')).be.true;
        });
        ...
        it('should return false if path has more than one part as replacement for * at the end of pattern', () => {
            expect(PathMatcher.match('https://some-public-url/path/test/other-test', 'https://some-public-url/path/*')).be.false;
        });
        ...
        it('should return false if path starts with https:// and * is at the beginning of pattern', () => {
            expect(PathMatcher.match('https://some-public-url/path/test', '*/some-public-url/path')).be.false;
        });
    });
});
