...
describe('ContentMetadataComponent', () => {
    ...
    describe('Saving', () => {
        ...
        it('should call removeTag and assignTagsToNode on TagService on save click', async() => {
    ...
    describe('Display properties with aspect oriented config', () => {
        ...
        it('should show Versionable with given content-metadata config', async () => {
            ...
            getClassSpy.and.returnValue(Promise.resolve(versionableResponse));
    ...
    describe('Tags creator', () => {
        ...
        it('should have assigned false to disabledTagsRemoving if forkJoin fails', async() => {
            const property = { key: 'properties.property-key', value: 'original-value' } as CardViewBaseItemModel;
            const expectedNode = { ...node, name: 'some-modified-value' };
            spyOn(nodesApiService, 'updateNode').and.returnValue(of(expectedNode));
            const tagPaging = mockTagPaging();
