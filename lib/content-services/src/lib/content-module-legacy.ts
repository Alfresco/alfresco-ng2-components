...
export class ContentModuleLegacy {
    static forRoot(): ModuleWithProviders<ContentModuleLegacy> {
        return {
            ngModule: ContentModuleLegacy,
            providers: [
    ...
    static forChild(): ModuleWithProviders<ContentModuleLegacy> {
        return {
            ngModule: ContentModuleLegacy
        };
    }
