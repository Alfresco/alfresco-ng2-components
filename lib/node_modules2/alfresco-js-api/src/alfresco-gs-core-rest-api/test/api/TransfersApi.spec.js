...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlfrescoGovernanceServicesRestApi.TransfersApi();
  });
  ...
  describe('TransfersApi', function() {
    ...
    describe('listTransfersChildren', function() {
      it('should call listTransfersChildren successfully', function(done) {
        //uncomment below and update the code to test listTransfersChildren
        //instance.listTransfersChildren(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
