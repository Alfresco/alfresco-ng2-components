...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlfrescoGovernanceServicesRestApi.RMNodeBodyCreate();
  });
  ...
  describe('RMNodeBodyCreate', function() {
    it('should create an instance of RMNodeBodyCreate', function() {
      // uncomment below and update the code to test RMNodeBodyCreate
      //var instane = new AlfrescoGovernanceServicesRestApi.RMNodeBodyCreate();
      //expect(instance).to.be.a(AlfrescoGovernanceServicesRestApi.RMNodeBodyCreate);
    });
