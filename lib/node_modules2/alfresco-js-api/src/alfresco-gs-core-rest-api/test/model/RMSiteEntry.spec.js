...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlfrescoGovernanceServicesRestApi.RMSiteEntry();
  });
  ...
  describe('RMSiteEntry', function() {
    it('should create an instance of RMSiteEntry', function() {
      // uncomment below and update the code to test RMSiteEntry
      //var instane = new AlfrescoGovernanceServicesRestApi.RMSiteEntry();
      //expect(instance).to.be.a(AlfrescoGovernanceServicesRestApi.RMSiteEntry);
    });
