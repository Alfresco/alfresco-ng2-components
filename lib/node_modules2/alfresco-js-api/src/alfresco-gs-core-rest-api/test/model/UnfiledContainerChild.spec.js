...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlfrescoGovernanceServicesRestApi.UnfiledContainerChild();
  });
  ...
  describe('UnfiledContainerChild', function() {
    it('should create an instance of UnfiledContainerChild', function() {
      // uncomment below and update the code to test UnfiledContainerChild
      //var instane = new AlfrescoGovernanceServicesRestApi.UnfiledContainerChild();
      //expect(instance).to.be.a(AlfrescoGovernanceServicesRestApi.UnfiledContainerChild);
    });
