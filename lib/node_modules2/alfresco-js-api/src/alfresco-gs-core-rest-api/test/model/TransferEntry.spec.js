...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlfrescoGovernanceServicesRestApi.TransferEntry();
  });
  ...
  describe('TransferEntry', function() {
    it('should create an instance of TransferEntry', function() {
      // uncomment below and update the code to test TransferEntry
      //var instane = new AlfrescoGovernanceServicesRestApi.TransferEntry();
      //expect(instance).to.be.a(AlfrescoGovernanceServicesRestApi.TransferEntry);
    });
