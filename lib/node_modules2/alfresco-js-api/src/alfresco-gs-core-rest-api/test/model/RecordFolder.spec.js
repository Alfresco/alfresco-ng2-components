...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlfrescoGovernanceServicesRestApi.RecordFolder();
  });
  ...
  describe('RecordFolder', function() {
    it('should create an instance of RecordFolder', function() {
      // uncomment below and update the code to test RecordFolder
      //var instane = new AlfrescoGovernanceServicesRestApi.RecordFolder();
      //expect(instance).to.be.a(AlfrescoGovernanceServicesRestApi.RecordFolder);
    });
