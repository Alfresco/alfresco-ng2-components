...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlfrescoGovernanceServicesRestApi.FilePlan();
  });
  ...
  describe('FilePlan', function() {
    it('should create an instance of FilePlan', function() {
      // uncomment below and update the code to test FilePlan
      //var instane = new AlfrescoGovernanceServicesRestApi.FilePlan();
      //expect(instance).to.be.a(AlfrescoGovernanceServicesRestApi.FilePlan);
    });
