...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlfrescoGovernanceServicesRestApi.TransferContainer();
  });
  ...
  describe('TransferContainer', function() {
    it('should create an instance of TransferContainer', function() {
      // uncomment below and update the code to test TransferContainer
      //var instane = new AlfrescoGovernanceServicesRestApi.TransferContainer();
      //expect(instance).to.be.a(AlfrescoGovernanceServicesRestApi.TransferContainer);
    });
