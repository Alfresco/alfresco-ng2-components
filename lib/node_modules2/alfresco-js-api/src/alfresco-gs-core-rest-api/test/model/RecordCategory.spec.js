...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlfrescoGovernanceServicesRestApi.RecordCategory();
  });
  ...
  describe('RecordCategory', function() {
    it('should create an instance of RecordCategory', function() {
      // uncomment below and update the code to test RecordCategory
      //var instane = new AlfrescoGovernanceServicesRestApi.RecordCategory();
      //expect(instance).to.be.a(AlfrescoGovernanceServicesRestApi.RecordCategory);
    });
