...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlfrescoGovernanceServicesRestApi.RMSiteBodyCreate();
  });
  ...
  describe('RMSiteBodyCreate', function() {
    it('should create an instance of RMSiteBodyCreate', function() {
      // uncomment below and update the code to test RMSiteBodyCreate
      //var instane = new AlfrescoGovernanceServicesRestApi.RMSiteBodyCreate();
      //expect(instance).to.be.a(AlfrescoGovernanceServicesRestApi.RMSiteBodyCreate);
    });
