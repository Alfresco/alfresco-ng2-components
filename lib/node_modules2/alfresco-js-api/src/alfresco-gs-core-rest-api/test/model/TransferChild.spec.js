...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlfrescoGovernanceServicesRestApi.TransferChild();
  });
  ...
  describe('TransferChild', function() {
    it('should create an instance of TransferChild', function() {
      // uncomment below and update the code to test TransferChild
      //var instane = new AlfrescoGovernanceServicesRestApi.TransferChild();
      //expect(instance).to.be.a(AlfrescoGovernanceServicesRestApi.TransferChild);
    });
