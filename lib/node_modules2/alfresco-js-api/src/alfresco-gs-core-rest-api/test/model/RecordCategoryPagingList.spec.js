...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlfrescoGovernanceServicesRestApi.RecordCategoryPagingList();
  });
  ...
  describe('RecordCategoryPagingList', function() {
    it('should create an instance of RecordCategoryPagingList', function() {
      // uncomment below and update the code to test RecordCategoryPagingList
      //var instane = new AlfrescoGovernanceServicesRestApi.RecordCategoryPagingList();
      //expect(instance).to.be.a(AlfrescoGovernanceServicesRestApi.RecordCategoryPagingList);
    });
