...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlfrescoGovernanceServicesRestApi.FilePlanEntry();
  });
  ...
  describe('FilePlanEntry', function() {
    it('should create an instance of FilePlanEntry', function() {
      // uncomment below and update the code to test FilePlanEntry
      //var instane = new AlfrescoGovernanceServicesRestApi.FilePlanEntry();
      //expect(instance).to.be.a(AlfrescoGovernanceServicesRestApi.FilePlanEntry);
    });
