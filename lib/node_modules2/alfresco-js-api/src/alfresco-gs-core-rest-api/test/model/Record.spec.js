...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlfrescoGovernanceServicesRestApi.Record();
  });
  ...
  describe('Record', function() {
    it('should create an instance of Record', function() {
      ...
      //var instane = new AlfrescoGovernanceServicesRestApi.Record();
      //expect(instance).to.be.a(AlfrescoGovernanceServicesRestApi.Record);
    });
