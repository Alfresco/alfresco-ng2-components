...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlfrescoGovernanceServicesRestApi.RecordEntry();
  });
  ...
  describe('RecordEntry', function() {
    it('should create an instance of RecordEntry', function() {
      // uncomment below and update the code to test RecordEntry
      //var instane = new AlfrescoGovernanceServicesRestApi.RecordEntry();
      //expect(instance).to.be.a(AlfrescoGovernanceServicesRestApi.RecordEntry);
    });
