...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlfrescoGovernanceServicesRestApi.UnfiledRecordFolder();
  });
  ...
  describe('UnfiledRecordFolder', function() {
    it('should create an instance of UnfiledRecordFolder', function() {
      // uncomment below and update the code to test UnfiledRecordFolder
      //var instane = new AlfrescoGovernanceServicesRestApi.UnfiledRecordFolder();
      //expect(instance).to.be.a(AlfrescoGovernanceServicesRestApi.UnfiledRecordFolder);
    });
