...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlfrescoGovernanceServicesSecurityControls.Instruction();
  });
  ...
  describe('Instruction', function() {
    it('should create an instance of Instruction', function() {
      // uncomment below and update the code to test Instruction
      //var instane = new AlfrescoGovernanceServicesSecurityControls.Instruction();
      //expect(instance).to.be.a(AlfrescoGovernanceServicesSecurityControls.Instruction);
    });
