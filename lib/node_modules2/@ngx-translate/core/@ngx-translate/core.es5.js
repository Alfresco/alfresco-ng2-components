...
import { ChangeDetectorRef, Directive, ElementRef, EventEmitter, Inject, Injectable, InjectionToken, Input, NgModule, Pipe } from '@angular/core';
...
var TranslateService = (function () {
    ...
    TranslateService.prototype.getParsedResult = function (translations, key, interpolateParams) {
        ...
        if (key instanceof Array) {
            ...
            if (observables) {
                ...
                return mergedObs.pipe(toArray$1(), map$1(function (arr) {
                    var obj = {};
    ...
    TranslateService.prototype.stream = function (key, interpolateParams) {
        ...
        return this
            ...
            .pipe(concat_3(this.onLangChange.pipe(switchMap$1(function (event) {
