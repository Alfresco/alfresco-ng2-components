...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            { pattern: 'lib/core/src/lib/assets/images/*.svg', included: false, served: true, watched: false },
        ...
        proxies: {
            ...
            '/resources/i18n/en-US.json': '/base/lib/process-services-cloud/src/lib/mock/en.json',
            '/resources/i18n/fr.json': '/base/lib/process-services-cloud/src/lib/mock/fr.json',
            '/base/assets/': '/base/lib/process-services/assets/',
            '/base/lib/process-services-cloud/src/lib/assets/images/': '/base/lib/core/src/lib/assets/images/',
            ...
            '/assets/adf-core/i18n/fr.json': '/base/lib/core/src/lib/i18n/fr.json',
            '/base/lib/core/src/lib/i18n/fr.json': '/base/lib/core/src/lib/i18n/fr.json',
            ...
            '/ecm/alfresco/api/-default-/public/alfresco/versions/1/nodes/-my-': 'http://localhost:9876/ecm/alfresco/api/-default-/public/alfresco/versions/1/nodes/-my-'
        },
        plugins: [
