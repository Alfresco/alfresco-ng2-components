...
module.exports = function (config) {
    config.set({
        basePath: '../../',
        files: [
            { pattern: 'node_modules/pdfjs-dist/build/pdf.mjs', included: true, watched: false, type: 'module' },
            { pattern: 'node_modules/pdfjs-dist/build/pdf.worker.mjs', included: true, watched: false, type: 'module' },
