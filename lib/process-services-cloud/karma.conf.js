...
module.exports = function (config) {
    config.set({
        basePath: '../../',
        files: [
            { pattern: 'node_modules/pdfjs-dist/legacy/build/pdf.js', included: true, watched: false },
            { pattern: 'node_modules/pdfjs-dist/legacy/build/pdf.worker.js', included: true, watched: false },
            { pattern: 'node_modules/pdfjs-dist/legacy/web/pdf_viewer.js', included: true, watched: false },
            {
