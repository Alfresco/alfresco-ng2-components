...
export let fakeFilters = {
    ...
    data: [
        new ProcessInstanceFilterRepresentationModel(
            {
                id: 1, name: 'FakeInvolvedProcesses', recent: false, icon: 'glyphicon-align-left',
                filter: { sort: 'created-desc', name: '', state: 'open', assignment: 'fake-involved' }
            }
        ),
        {
            id: 2, name: 'FakeMyProcesses', recent: false, icon: 'glyphicon-align-left',
...
export let fakeProcessesComment = {
    size: 2, total: 2, start: 0,
    data: [
        {
...
export let fakeProcessesChecklist = {
    size: 1, total: 1, start: 0,
    data: [
        {
...
export let fakeRepresentationFilter1: ProcessInstanceFilterRepresentationModel = new ProcessInstanceFilterRepresentationModel({
    appId: 1,
    name: 'CONTAIN FILTER',
    recent: true,
...
export let fakeRepresentationFilter2: ProcessInstanceFilterRepresentationModel = new ProcessInstanceFilterRepresentationModel({
    appId: 2,
    name: 'NO TASK FILTER',
    recent: false,
