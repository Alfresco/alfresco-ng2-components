...
import { FormService, ContentService, ProcessContentService, setupTestBed, FormFieldModel, FormModel, FormFieldTypes, FormFieldMetadata } from '@alfresco/adf-core';
...
fdescribe('AttachFileCloudWidgetComponent', () => {
  ...
  fit('should be able to attach files coming from content selector', async(() => {
    ...
    fixture.whenStable().then(() => {
      ...
      debugger;
      console.log(widget.field.value);
      attachButton.click();
      fixture.whenStable().then(() => {
        fixture.detectChanges();
