...
describe('DropdownCloudWidgetComponent', () => {
    ...
    describe('variable options', () => {
        ...
        it('should set dropdownControl value to null when field value is default/empty option object', fakeAsync(() => {
            widget.field = {
                value: { id: 'empty', name: 'Choose one...' },
                options: [],
                isVisible: true,
                markAsValid: () => {}
            } as FormFieldModel;
        ...
        it('should set dropdownControl value to null when field value object has empty id', fakeAsync(() => {
            widget.field = {
                value: { id: '', name: 'label' },
                options: [],
                isVisible: true,
