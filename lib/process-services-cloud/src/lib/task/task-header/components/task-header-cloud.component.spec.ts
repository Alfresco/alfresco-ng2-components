...
describe('TaskHeaderCloudComponent', () => {
    ...
    describe('Task Details', () => {
        ...
        it('should display due date', async () => {
            ...
            expect(valueEl.nativeElement.innerText.trim()).toBe('Monday, December 17, 2018, 12:00:55 PM GMT+00:00');
        });
    ...
    describe('Config properties', () => {
        ...
        it('should format the dates based on app config format configuration', async () => {
            ...
            expect(createdDateElement.nativeElement.innerText.trim()).toBe('Monday, December 17, 2018, 12:00:00 AM GMT+00:00');
        });
    });
