...
// import { LogService, AppConfigService, StorageService, setupTestBed, CoreModule } from '@alfresco/adf-core';
...
//
//     beforeEach(async(() => {
//         service = new TaskFilterService( new LogService(new AppConfigService(null)), new StorageService());
