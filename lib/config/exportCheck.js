...
var print_errors = function () {
    error_array.forEach(function (current_error) {
        console.log(chalk_1.default.red("" + current_error));
    });
};
var warning_array = [];
var add_warning = function (error) {
    warning_array.push(error);
};
var print_warnings = function () {
    warning_array.forEach((function (current_warning) {
        console.log(chalk_1.default.yellow("" + current_warning));
    }));
};
...
function generatExportList(fileNames, options) {
    ...
    function serializeSymbol(className, line, character, fileName) {
        return {
            position: {
                line: line,
                character: character,
    ...
    function serializeClass(className, line, character, fileName) {
        var details = serializeSymbol(className, line, character, fileName);
        return details;
    }
