...
module.exports = {
    ...
    resolve: {
        alias: {
            "@alfresco/content-services": path.resolve(__dirname, '../src/content-services/'),
            "@alfresco/content-services$": path.resolve(__dirname, '../src/content-services/index.ts'),
            "@alfresco/process-services": path.resolve(__dirname, '../src/process-services/'),
            "@alfresco/process-services$": path.resolve(__dirname, '../src/process-services/index.ts'),
            "@alfresco/core": path.resolve(__dirname, '../src/core/'),
            "@alfresco/core$": path.resolve(__dirname, '../src/core/index.ts')
        },
